...
function(req) {
  htmlTemplate("index.html",
                ...
                line_chart = plotlyOutput("LINE", width = "1000px", height = "500px"),
                yoy_chart = plotlyOutput("YOY", width = "1000px", height = "500px"),
                bar_chart = plotlyOutput("BARCH", width = "1000px", height = "500px"),
